                  ...
                  <Carousel ref={sliderRef}>
                    <Carousel.Item interval={3000}>
                      <Carousel.Caption className="carousel-caption text-dark text-start">
                        <h2 className="fs-1 fw-bold mb-2"><span>Car Maintenance</span><br /><span className="primary-color">Fast</span></h2>
                    ...
                    <Carousel.Item interval={3000}>
                      <Carousel.Caption className="carousel-caption text-dark text-start">
                        <h2 className="fs-1 fw-bold mb-2"><span>Cars on Showroom</span><br /><span className="primary-color">For you</span></h2>
                        <p className="fs-3 m-0">
                          Schedule now!!!.
                        </p>
                      </Carousel.Caption>
