  ...
  return (
    <div id="features-section">
      <Container className="py-5">
        <Row>
          <Col>
            <h1 className="quinary-color fs-1 p-0 mb-4">WHY CHOOSE CAR WORLD</h1>
          </Col>
        </Row>
        <Row>
          <Col xs={4}>
            ...
            <p className="quinary-color fs-6 m-0 pb-2"> </p>
          </Col>
          <Col xs={4}>
            <HiOutlineStatusOnline size="2.5em" color="white" />
            <h4 className="quinary-color fs-5 py-1">Convenient booking</h4>
            <p className="quinary-color fs-6 m-0 pb-2"> </p>
          </Col>
          <Col xs={4}>
